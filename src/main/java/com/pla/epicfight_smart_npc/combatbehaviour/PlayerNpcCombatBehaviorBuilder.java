...
public final class PlayerNpcCombatBehaviorBuilder {
    private static final int WEAPON_ENDER_PEARL_AWAY_COOLDOWN = 60;

    private PlayerNpcCombatBehaviorBuilder() {
    }
    ...
    public static Builder<MobPatch<?>> weapon(
        ...
        return CECombatBehaviors.builder()
                ...
                .newBehaviorRoot(CombatBehaviourTemplates.playerNpcWaterBucketRoot())
                .newBehaviorRoot(CombatBehaviourTemplates.playerNpcLavaBucketRoot())
