...
public final class CombatBehaviourTemplates {
    ...
    public static BehaviorRoot.Builder<MobPatch<?>> playerNpcLavaBucketRoot() {
        return BehaviorRoot.builder()
                .priority(2.0D)
                .weight(30.0D)
                .maxCooldown(120)
                .addFirstBehavior(
                        Behavior.builder()
                                .custom(CombatCommon::canPerformNormalAttackLogic)
                                .custom(CombatCommon::canUsePlayerNpcLavaBucket)
                                .withinDistance(0.0D, 5.0D)
                                .animationBehavior(SmartNpcAnimations.SWING_HAND_LEFT, 0.0F)
                                .addExBehavior(CombatCommon::performPlayerNpcLavaBucket)
                );
    }

    public static BehaviorRoot.Builder<MobPatch<?>> playerNpcWaterBucketRoot() {
        return BehaviorRoot.builder()
                .priority(3.0D)
                .weight(1000.0D)
                .maxCooldown(80)
                .addFirstBehavior(
                        Behavior.builder()
                                .custom(CombatCommon::canUsePlayerNpcWaterBucketSelfExtinguish)
                                .animationBehavior(SmartNpcAnimations.SWING_HAND_LEFT, 0.0F)
                                .addExBehavior(CombatCommon::performPlayerNpcWaterBucketSelfExtinguish)
                );
    }
