...
public class PlayerNpcAvBlockWeapon {
    public static final Builder<MobPatch<?>> WOODEN_DOOR = PlayerNpcCombatBehaviorBuilder.weapon(
    ...
    public static final Builder<MobPatch<?>> TRAPDOOR = PlayerNpcCombatBehaviorBuilder.weapon(
            CombatCommon.animations(
    ...
    public static final Builder<MobPatch<?>> LADDER = PlayerNpcCombatBehaviorBuilder.weapon(
            CombatCommon.animations(
                    Animations.SWORD_AUTO1,
                    Animations.SWORD_AUTO3,
    ...
    public static final Builder<MobPatch<?>> CRAFTING_TABLE = PlayerNpcCombatBehaviorBuilder.weapon(
            CombatCommon.animations(
