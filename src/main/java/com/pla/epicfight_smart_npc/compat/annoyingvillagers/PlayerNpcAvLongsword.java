...
public class PlayerNpcAvLongsword {
    public static final Builder<MobPatch<?>> AV_LONGSWORD = PlayerNpcCombatBehaviorBuilder.weapon(
    ...
    public static final Builder<MobPatch<?>> DUAL_AV_LONGSWORD = PlayerNpcCombatBehaviorBuilder.weapon(
            CombatCommon.animations(
    ...
    public static final Builder<MobPatch<?>> CHIPPED_LONGSWORD = PlayerNpcCombatBehaviorBuilder.weapon(
            CombatCommon.animations(
                    AnimsRuine.RUINE_AUTO_1,
                    AnimsRuine.RUINE_AUTO_2,
                    AnimsRuine.RUINE_AUTO_3,
    ...
    public static final Builder<MobPatch<?>> DIAMOND_SABRE = PlayerNpcCombatBehaviorBuilder.weapon(
            CombatCommon.animations(
