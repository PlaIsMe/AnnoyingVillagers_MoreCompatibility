...
public class PlayerNpcAvAxe {
    ...
    public static final Builder<MobPatch<?>> DUAL_EXTERMINATOR_BATTLE_AXE = PlayerNpcCombatBehaviorBuilder.weapon(
            CombatCommon.animations(
    ...
    private static Builder<MobPatch<?>> guardedAxe(
        ...
        return PlayerNpcCombatBehaviorBuilder.weapon(opener, axeHeavyAnimations(), finisher);
    }
