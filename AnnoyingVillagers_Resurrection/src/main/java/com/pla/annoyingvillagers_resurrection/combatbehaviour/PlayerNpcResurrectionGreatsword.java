...
public class PlayerNpcResurrectionGreatsword {
    public static final CECombatBehaviors.Builder<MobPatch<?>> S_GREATSWORD = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    ...
                    CECombatBehaviors.BehaviorRoot.builder()
                            ...
                            .addFirstBehavior(
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .animationBehavior(CorruptAnimations.GREATSWORD_OLD_AUTO1, 0.0F)
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.GREATSWORD_OLD_AUTO2, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 3.0D)
                                                                            .animationBehavior(CorruptAnimations.GREATSWORD_OLD_AUTO3, 0.0F)
                                                            )
                                            )
                            )
                            .addFirstBehavior(
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.GREATSWORD_OLD_DASH, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                    ...
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.GREATSWORD_OLD_AIRSLASH, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 4.0D)
                                                                            ...
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 4.0D)
                                                                                            .animationBehavior(CorruptAnimations.WIND_SLASH, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .withinDistance(0.0D, 5.0D)
...
/* 10 */
    ...
    public static final CECombatBehaviors.Builder<MobPatch<?>> DUAL_S_GREATSWORD = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    CECombatBehaviors.BehaviorRoot.builder()
                            .priority(4.0D)
                            .weight(1000.0D)
                    ...
                    CECombatBehaviors.BehaviorRoot.builder()
                            ...
                            .addFirstBehavior(
                                    CECombatBehaviors.Behavior.builder()
                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                            .withinDistance(0.0D, 3.0D)
                                            .animationBehavior(CorruptAnimations.DUAL_GREATSWORD_AUTO1, 0.0F)
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.DUAL_GREATSWORD_AUTO2, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 3.0D)
                                                                            .animationBehavior(CorruptAnimations.DUAL_GREATSWORD_AUTO3, 0.0F)
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 3.0D)
                                                                                            .animationBehavior(CorruptAnimations.DUAL_GREATSWORD_AUTO4, 0.0F)
                                                                            )
                                                            )
                                            )
                            )
                                    ...
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.DUAL_GREATSWORD_DASH, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 4.0D)
                                    ...
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.DUAL_GREATSWORD_AIRSLASH, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 4.0D)
                                                                            ...
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 4.0D)
                                                                                            .animationBehavior(CorruptAnimations.DUAL_GREATSWORD_SKILL, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .withinDistance(0.0D, 5.0D)
