...
public class PlayerNpcResurrectionSword {
    public static final CECombatBehaviors.Builder<MobPatch<?>> S_SWORD = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    ...
                    CECombatBehaviors.BehaviorRoot.builder()
                            ...
                            .addFirstBehavior(
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .animationBehavior(CorruptAnimations.SWORD_ONEHAND_AUTO1, 0.0F)
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.SWORD_ONEHAND_AUTO2, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 3.0D)
                                                                            .animationBehavior(CorruptAnimations.SWORD_ONEHAND_AUTO3, 0.0F)
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 3.0D)
                                                                                            .animationBehavior(CorruptAnimations.SWORD_ONEHAND_AUTO4, 0.0F)
                                                                            )
                                                            )
                                            )
                            )
                                    ...
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.SWORD_ONEHAND_DASH, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                    ...
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            ...
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 4.0D)
                                                                                            .animationBehavior(CorruptAnimations.SWORD_SLASH, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .withinDistance(0.0D, 5.0D)
...
/* 10 */
    ...
    public static final CECombatBehaviors.Builder<MobPatch<?>> DUAL_S_SWORD = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    CECombatBehaviors.BehaviorRoot.builder()
                            .priority(4.0D)
                            .weight(1000.0D)
                                                    ...
                                                    CECombatBehaviors.Behavior.builder()
                                                            ...
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 3.0D)
                                                                            .animationBehavior(Animations.DAGGER_DUAL_AUTO3, 0.0F)
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 3.0D)
                                                                                            ...
                                                                                            .addNextBehavior(
                                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .withinDistance(0.0D, 3.0D)
                                                                                                            .animationBehavior(Animations.DAGGER_DUAL_AUTO4, 0.0F)
                                                                                            )
                                                                            )
                                                            )
                                            )
                                                                    ...
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            ...
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 4.0D)
                                                                                            .animationBehavior(CorruptAnimations.DUAL_SLASH, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .withinDistance(0.0D, 5.0D)
