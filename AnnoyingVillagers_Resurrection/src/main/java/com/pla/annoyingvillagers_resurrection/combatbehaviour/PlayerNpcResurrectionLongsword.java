...
public class PlayerNpcResurrectionLongsword {
    public static final CECombatBehaviors.Builder<MobPatch<?>> S_LONGSWORD = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    ...
                    CECombatBehaviors.BehaviorRoot.builder()
                            ...
                            .addFirstBehavior(
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .animationBehavior(CorruptAnimations.TACHI_TWOHAND_AUTO_1, 0.0F)
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(CorruptAnimations.TACHI_TWOHAND_AUTO_2, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 3.0D)
                                                                            .animationBehavior(CorruptAnimations.TACHI_TWOHAND_AUTO_3, 0.0F)
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 3.0D)
                                                                                            .animationBehavior(CorruptAnimations.TACHI_TWOHAND_AUTO_4, 0.0F)
                                                                            )
                                                            )
                                            )
                            )
