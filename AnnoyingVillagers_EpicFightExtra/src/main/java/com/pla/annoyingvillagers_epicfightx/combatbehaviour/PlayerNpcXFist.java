...
public class PlayerNpcXFist {
    public static final Builder<MobPatch<?>> X_FIST = CECombatBehaviors.builder()
            .newBehaviorRoot(
                    ...
                    BehaviorRoot.builder()
                            ...
                            .addFirstBehavior(
                                    Behavior.builder()
                                            ...
                                            .animationBehavior(AnimationsX.FIST_AUTO1, 0.0F)
                                            .addNextBehavior(
                                                    Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(AnimationsX.FIST_AUTO2, 0.0F)
                                                            .addNextBehavior(
                                                                    Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                                            .withinDistance(0.0D, 3.0D)
                                                                            .animationBehavior(AnimationsX.FIST_AUTO3, 0.0F)
                                                                            .addNextBehavior(
                                                                                    Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                                                            .withinDistance(0.0D, 3.0D)
                                                                                            .animationBehavior(ExtraAnimations.FIST_AUTO4, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                                                                            .withinDistance(0.0D, 3.0D)
                                                                                                            .animationBehavior(ExtraAnimations.FIST_AUTO5, 0.0F)
                                                                                            )
                                                                            )
                                                            )
                                            )
                                    ...
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            ...
                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(AnimationsX.FIST_DASH, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                    ...
                                    CECombatBehaviors.Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    CECombatBehaviors.Behavior.builder()
                                                            ...
                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                            .withinDistance(0.0D, 3.0D)
                                                            .animationBehavior(AnimationsX.FIST_AIR_SLASH, 0.0F)
                                                            .addNextBehavior(
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                                    ...
                                                                    CECombatBehaviors.Behavior.builder()
                                                                            ...
                                                                            .addNextBehavior(
                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                            ...
                                                                                            .custom(CombatCommon::canAttackWhileNotHealing)
                                                                                            .withinDistance(0.0D, 4.0D)
                                                                                            .animationBehavior(AnimationsX.RELENTLESS_COMBO, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    CECombatBehaviors.Behavior.builder()
                                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                                            .custom(CombatCommon::canAttackWhileNotHealing)
