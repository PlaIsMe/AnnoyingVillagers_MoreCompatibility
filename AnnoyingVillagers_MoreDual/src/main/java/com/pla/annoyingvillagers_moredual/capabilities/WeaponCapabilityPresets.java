...
import com.pla.annoyingvillagers_moredual.compat.epicfightx.EpicFightXDualAxe;
import com.pla.annoyingvillagers_moredual.compat.epicfightx.EpicFightXDualGreatsword;
import com.pla.annoyingvillagers_moredual.mixins.DualAxeMixin;
...
public class WeaponCapabilityPresets {
    ...
    public static void register(WeaponCapabilityPresetRegistryEvent event) {
        event.getTypeEntry().put(ResourceLocation.fromNamespaceAndPath("epicfight", "axe"),
        ...
        event.getTypeEntry().put(ResourceLocation.fromNamespaceAndPath("epicfight", "greatsword"),
                ModList.get().isLoaded("epicfightx") ?
